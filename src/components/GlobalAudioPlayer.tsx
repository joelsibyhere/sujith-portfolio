...
export function GlobalAudioPlayer() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-[60] animate-in slide-in-from-bottom-full duration-700 pointer-events-none">
      ...
      */}
      <div className="pointer-events-auto bg-card/95 backdrop-blur-xl border-t border-hairline px-6 py-4 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
        {/* Track Info */}
        ...
        <div className="flex items-center gap-4 w-full md:w-1/3">
          <div
            className="relative flex-1 h-1 bg-muted rounded-full cursor-pointer group"
            onClick={(e) => {
